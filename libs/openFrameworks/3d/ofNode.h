...
public:
	...
	OF_DEPRECATED_MSG("Use the Deg/Rad version",
	...
	OF_DEPRECATED_MSG("Use the Deg/Rad version", void orbit(float longitude, float latitude, float radius,
...
private:
	void onParentPositionChanged(glm::vec3 &position) {
		onPositionChanged();
	}
	void onParentOrientationChanged(glm::quat &orientation) {
		onOrientationChanged();
	}
	void onParentScaleChanged(glm::vec3 &scale) {
		onScaleChanged();
	}
