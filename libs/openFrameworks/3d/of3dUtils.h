...
/// \param numberOfSteps number of lines to draw on each side of the central axis of the grid. A number of 8 will draw 8
/// lines on each side of the central axis, plus one line at the central axis. \param labels Whether or not labels are
/// drawn. \param x Whether or not the yz plane (at x=0) is drawn. \param y Whether or not the xz plane (at y=0) is
/// drawn. \param z Whether or not the xy plane (at z=0) is drawn.
void ofDrawGrid(float stepSize = 1.25f, size_t numberOfSteps = 8, bool labels = false, bool x = true, bool y = true,
                bool z = true);
