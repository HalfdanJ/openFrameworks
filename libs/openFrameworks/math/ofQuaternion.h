...
public:
	...
	inline ofQuaternion(float angle1, const ofVec3f &axis1, float angle2, const ofVec3f &axis2, float angle3,
	                    const ofVec3f &axis3);
	...
	void makeRotate(float angle1, const ofVec3f &axis1, float angle2, const ofVec3f &axis2, float angle3,
	                const ofVec3f &axis3);
	...
	inline const ofQuaternion
	operator-() const; ///< returns the negative of the quaternion. calls operator -() on the Vec4
...
//----------------------------------------
ofQuaternion::ofQuaternion(float angle1, const ofVec3f &axis1, float angle2, const ofVec3f &axis2, float angle3,
                           const ofVec3f &axis3) {
...
//----------------------------------------
const ofQuaternion ofQuaternion::operator+(const ofQuaternion &rhs) const {
	return ofQuaternion(_v.x + rhs._v.x, _v.y + rhs._v.y, _v.z + rhs._v.z, _v.w + rhs._v.w);
}
