...
int ofGetGLFormatFromInternal(int glInternalFormat) {
	...
	default:
		ofLogError("ofGLUtils") << "ofGetGLFormatFromInternal(): unknown internal format " << glInternalFormat
		                        << ", returning GL_RGBA";
		return GL_RGBA;
	}
}
...
int ofGetGlTypeFromInternal(int glInternalFormat) {
	...
	default:
		ofLogError("ofGLUtils") << "ofGetGlTypeFromInternal(): unknown internal format " << glInternalFormat
		                        << ", returning GL_UNSIGNED_BYTE";
		return GL_UNSIGNED_BYTE;
	}
}
...
ofPolyRenderMode ofGetOFPolyMode(GLuint m) {
	...
	case(GL_FILL):
		...
		break;
	default:
		ofLogError("ofGLUtils") << "ofGetOFPolyMode(): unknown GL poly mode " << ofToString(m)
		                        << ", returning OF_MESH_FILL";
		return OF_MESH_FILL;
		break;
	}
#else
...
#endif
	default:
		ofLogError("ofGLUtils") << "ofGetGLPrimitiveMode(): unknown OF primitive mode " << ofToString(mode)
		                        << ", returning GL_TRIANGLES";
		return GL_TRIANGLES;
		break;
	}
}
...
#endif
	default:
		ofLogError("ofGLUtils") << "ofGetOFPrimitiveMode(): unknown GL primitive mode " << ofToString(mode)
		                        << ", returning OF_PRIMITIVE_TRIANGLES";
		return OF_PRIMITIVE_TRIANGLES;
		break;
	}
}
...
shared_ptr<ofBaseGLRenderer> ofGetGLRenderer() {
	if(ofGetCurrentRenderer()->getType() == ofGLRenderer::TYPE ||
