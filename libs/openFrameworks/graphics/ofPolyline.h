...
public:
	...
	void arc(const T &center, float radiusX, float radiusY, float angleBegin, float angleEnd, bool clockwise,
	...
	void arc(const T &center, float radiusX, float radiusY, float angleBegin, float angleEnd,
	         int circleResolution = 20) {
	...
	void arcNegative(const T &center, float radiusX, float radiusY, float angleBegin, float angleEnd,
	                 int circleResolution = 20) {
...
private:
	...
	mutable std::vector<float>
	    lengths; // cumulative lengths, stored per point (lengths[n] is the distance to the n'th point, zero based)
...
template<class T> bool ofInsidePoly(float x, float y, const std::vector<T> &polygon) {
...
template<class T> bool ofInsidePoly(const T &p, const std::vector<T> &poly) {
