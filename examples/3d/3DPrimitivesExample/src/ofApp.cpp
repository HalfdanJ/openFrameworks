...
//--------------------------------------------------------------
void ofApp::update() {
	pointLight.setPosition((ofGetWidth() * .5) + cos(ofGetElapsedTimef() * .5) * (ofGetWidth() * .3), ofGetHeight() / 2,
	                       500);
...
void ofApp::draw() {
	...
	ofDrawBitmapStringHighlight("ofPlanePrimitive",
	                            glm::vec3(-90, -160, 0) + cam.worldToScreen(plane.getGlobalPosition()));
	...
	ofDrawBitmapStringHighlight("ofIcoSpherePrimitive",
	                            glm::vec3(-90, +160, 0) + cam.worldToScreen(icoSphere.getPosition()));
	ofDrawBitmapStringHighlight("ofCylinderPrimitive",
	                            glm::vec3(-90, +160, 0) + cam.worldToScreen(cylinder.getPosition()));
