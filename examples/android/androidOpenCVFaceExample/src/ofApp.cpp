...
void ofApp::draw() {
	...
	for(int i = 0; i < faces.size(); i++) {
		...
		ofRectangle rect(face.boundingRect.x * scaleFactor, face.boundingRect.y * scaleFactor,
		                 face.boundingRect.width * scaleFactor, face.boundingRect.height * scaleFactor);
