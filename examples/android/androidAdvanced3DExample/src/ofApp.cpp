...
void ofApp::drawScene(int iCameraDraw) {
	...
	if(iCameraDraw != 0) {
		...
		inverseCameraMatrix.makeInvertOf(
		    camEasyCam.getModelViewProjectionMatrix((iMainCamera == 0 ? viewMain : viewGrid[0])));
		...
		//
		GLfloat vertices1[] = {-1.0f, -1.0f, -1.0f, -1.0f, 1.0f, -1.0f, 1.0f, 1.0f, -1.0f, 1.0f, -1.0f, -1.0f};
		...
		//
		GLfloat vertices2[] = {-1.0f, -1.0f, 1.0f, -1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, -1.0f, 1.0f};
		...
		//
		GLfloat vertices3[] = {-1.0f, 1.0f,  -1.0f, -1.0f, 1.0f,  1.0f,
