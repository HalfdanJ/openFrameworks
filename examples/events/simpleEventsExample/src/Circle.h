...
public:
	...
	// this object can be declared as class variable so events are broadcasted and listened for each specific class
	// instance. the data type of the event, what's declared between the < > can be whatever you want, event a custom
	// class.
	ofEvent<ofVec2f> clickedInside;

	// this is a shared event for all the instances of this class, so any instance of this class will broadcast to the
	// same event, this way you'll have to register only one listener to listen to any class instance broadcasting to
	// this event.
