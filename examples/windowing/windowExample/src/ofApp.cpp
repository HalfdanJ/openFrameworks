...
void ofApp::update() {
	...
	// [zach fix] ofSetWindowTitle(ofToString(ofGetFrameRate(), 2)+":fps - pos
	// ("+ofToString((int)windowX)+","+ofToString((int)windowY)+")");
...
void ofApp::draw() {
	...
	vagRounded.drawString(
	    "window pos (" + ofToString(ofGetWindowPositionX()) + ", " + ofToString(ofGetWindowPositionY()) + ")", 10, 25);
